...
aWr = zeros(N_y,1);aPr=zeros(N_y,1);
aEr = zeros(N_y,1);br=zeros(N_y,1);
aWk = zeros(N_y,1);aPk=zeros(N_y,1);
aEk = zeros(N_y,1);bk=zeros(N_y,1);
aWe = zeros(N_y,1);aPe=zeros(N_y,1);
aEe = zeros(N_y,1);be=zeros(N_y,1);
Ar = sparse(N_y,N_y);
Ak = sparse(N_y,N_y);Ae = sparse(N_y,N_y);
